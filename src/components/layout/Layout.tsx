...
import { LayoutDashboard, ShoppingCart, Package, Users, Settings, Moon, Sun, ChevronLeft, ChevronRight, LogOut, History, BarChart2, Truck } from "lucide-react";
...
export const Layout: React.FC<LayoutProps> = ({ children, currentPage, onPageChange }) => {
  ...
  const allMenuItems = [
    ...
    { id: "purchase-orders", icon: <Truck size={20} />, label: "Procurement", roles: ["owner", "admin", "manager"] },
